                        ...
                        ?>
                            <div class="position-center">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text"  name="product_sold" class="form-control" id="exampleInputEmail1" placeholder="Tên sản phẩm">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="meta_keywords" class="form-control" id="exampleInputEmail1" placeholder="Từ khóa danh mục">
                                </div>
                                <div class="form-group">
