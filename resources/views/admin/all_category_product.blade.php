                                    ...
                                    <tr>
                                       ...
                                       <?php
                                        ...
                                        <td>
                                            ...
                                            <a onclick="return confirm ('Bạn chăc chắn muốn xóa không')" href="{{URL::to('/delete-category-product/'.$cate_pro->category_id)}}" class="active styling-edit" ui-toggle-class="">
