                            ...
                            <table class="table table-striped b-t b-light">
                                ...
                                @foreach($comment as $key => $comm)
                                    ...
                                    <td>
                                        ...
                                        <td><a href="{{url('/chi-tiet-san-pham/'.$comm->product->product_id)}}"target="blank">{{ $comm->product->product_name}}</a></td>
                                        
                                        <td>
                                            <a href="" class="active styling-edit" ui-toggle-class="">
                                            <i class="fa fa-pencil-square-o text-success text-active"></i></a>
                                            <a onclick="return confirm ('Bạn chăc chắn muốn xóa không')" href="" class="active styling-edit" ui-toggle-class="">
